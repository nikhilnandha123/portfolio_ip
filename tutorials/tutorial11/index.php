	...
	<div class="container mt-4"> 
    	...
    	<table class="table table-dark table-striped text-center">
            ...
            <tr>
                    ...
                    <td><?=$row['note']?></td>
                    <td>
                        <button class="btn btn-primary"><a class="text-white" href="user_form.php?id=<?php echo $row['id'];?>">Edit</a></button>
                        <button class="btn btn-danger"><a class="text-white" href="user_delete.php?id=<?php echo $row['id'];?>">Delete</a></button>
                    </td>
            </tr>
        </tbody>
            <?php
