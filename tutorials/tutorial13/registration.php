...
<head>
    ...
    <style>
        /* body
            {
                background: #4b6cb1;
                background: -webkit-linear-gradient(to right, #182848, #4b6cb1);
                background: linear-gradient(to right, #182848, #4b6cb1);
            } */
                        ...
                        <div class="card-body">
                            ...
                            <div class="row p-1">
                                ...
                                <div class="col-md-8">
                                    ...
                                    class="form-control" type="file" accept=".jpg,.png,.jpeg,.bmp">
                                </div>
                            </div>
