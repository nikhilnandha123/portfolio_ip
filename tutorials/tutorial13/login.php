          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-8 p-2">
                <input type="email" class="form-control" id="username" name="username" placeholder="Username@example.com">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col p-2">
                <input type="checkbox" name="remember" checked id="remember"> Remember me
              </div>
            </div>
