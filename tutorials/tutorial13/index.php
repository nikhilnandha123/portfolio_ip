...
<body>
    ...
    <h2 class="text-danger" align="center">Book's Details</h2>        
        ...
        <div class="row p-1">
            <div class="col-md-8">
                <a class="link-primary" href="book_form.php"><h5>Insert Data</h5></a>
            </div>
            <div class="col-md-4">
        ...
        <table class="table table-dark table-striped">
            ...
            <tr>
                    ...
                    <td>
                        <button class="btn btn-primary"><a class="text-decoration-none text-white" href="book_form.php?id=<?php echo $row['id'];?>">Edit</a></button>
                        <button class="btn btn-danger"><a class="text-decoration-none text-white" href="book_delete.php?id=<?php echo $row['id'];?>" onclick=" return confirm('Are You Sure..?')">Delete</a></button>
                    </td>
            </tr>
        </tbody>
            <?php
